<%@ page title="" language="C#" masterpagefile="~/Site.master" autoeventwireup="true" inherits="Seguridad_Usuarios, App_Web_b1y0b0l5" %>
                ...
                <div class=" table-responsive">
                    <asp:GridView ID="dgvUsuario" CssClass="table table-striped table-bordered table-hover"
                        ...
                        <Columns>
                            ...
                            <asp:ButtonField Text="<span class='ui-icon ui-icon-trash'>" CommandName="deleteRecord" CausesValidation="false" />
