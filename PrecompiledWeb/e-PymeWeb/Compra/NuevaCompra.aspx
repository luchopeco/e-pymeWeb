<%@ page title="" language="C#" masterpagefile="~/Site.master" autoeventwireup="true" inherits="Compra_NuevaCompra, App_Web_xkzmi3kr" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                        ...
                        <div class=" row">
                            ...
                            <div class=" col-md-6">
                                ...
                                <asp:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" CompletionInterval="10"
                                    DelimiterCharacters="" Enabled="True" MinimumPrefixLength="3" ServiceMethod="BuscarArticulos"
                        ...
                        <div>
                            <asp:GridView ID="dgvArticulos" runat="server" CssClass="table table-striped table-bordered table-hover dataTable no-footer"
                                ...
                                <Columns>
                                    ...
                                    <asp:ButtonField CommandName="editArticulo" 
                                        Text="&lt;i class='fa fa-pencil-square-o'&gt;&lt;/i&gt;">
                                    <ControlStyle CssClass="btn btn-xs btn-info" />
                                    </asp:ButtonField>
                                    <asp:ButtonField CommandName="deleteArticulo" 
                ...
                <div class=" widget">
                    ...
                    <div class=" widget-content">
                        <asp:GridView ID="dgvFormaPago" CssClass="table table-striped table-bordered table-hover dataTable no-footer"
                            ...
                            onrowcommand="dgvFormaPago_RowCommand">
                            <Columns>
            ...
            <div class=" col-lg-12"> 
                <asp:TextBox ID="txtDescripcion" CssClass="form-control" PlaceHolder="Ingrese si desea una descripcion para la compra" runat="server"></asp:TextBox></div>
            <div class=" col-lg-12">
                ...
                <ContentTemplate>
                    <div class=" col-lg-12">
                        ...
                        Controlar Stock<asp:CheckBox ID="chbxControlarStock" CssClass=" form-control" runat="server"
                            AutoPostBack="True" OnCheckedChanged="chbxControlarStock_CheckedChanged" />
                        Cantidad
            ...
            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                <ContentTemplate>
                    <div class=" col-lg-12">
                        ...
                        Stock Actual<asp:TextBox ID="txtStock" Enabled="false" CssClass=" form-control" runat="server"></asp:TextBox>
                        Costo Unitario
                    ...
                    <div class="modal-footer">
                        <asp:Button ID="btnAgregarArticuloExistente" runat="server" Text="Agregar" CssClass="btn btn-success"
                            CausesValidation="True" ValidationGroup="BusquedaArticulo" 
                            onclick="btnAgregarArticuloExistente_Click" />
                        <button class="btn btn-danger" data-dismiss="modal" aria-hidden="true">
                            Cancelar</button>
                    </div>
                </ContentTemplate>
